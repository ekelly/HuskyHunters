...
public final class DbConstants {
	...
	public static final String TOTAL_PICTURES = "total_pics";
	...
	public static final String SQL_DEVICE_TABLE_CREATION =
			"CREATE TABLE " + DEVICE_TABLE + " (" + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
	...
	// Sum portion of SELECT statment
	...
	public static final String[] SQL_SELECT = new String[]{BaseColumns._ID, CLUEID, SERVER_TEXT, SERVER_ANS,
